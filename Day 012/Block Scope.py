...
# blocks of code e.g. for loops, if statements, while
# loops etc. don't get local scope. They are given function
# scope if they are within a function or global scope if they are not.
